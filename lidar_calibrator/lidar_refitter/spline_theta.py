...
material_dict = {
    "Aluminium": {
        ...
        "spline_coefs": np.array(
            [-0.03669465, 0.14803687, -0.22405445, 0.15701279, 0.28178591, 0.38203843, 0.09171097, 0.33909473,
             0.36862915, 0.66832097, 0.53964095, 0.73963473, 0.679984, 0.93491434, 0.94019927, 1.05936161, 0.97708951]),
        "spline_degree": 3
    },
    "SUS": {
        ...
        "spline_knots": np.array(
            [1.0, 6.6, 8.0, 8.7, 9.1, 9.4, .8, 12.1, 17.7, 23.2, 34.3, 39.9, 45.4, 56.5, 67.6, 89.7]),
        "spline_coefs": np.array(
            [-0.01205687, 0.05382891, -0.11811259, 0.16537451, 0.16514144, 0.24220003, 0.29965838, 0.26438822,
             0.41168756, 0.30525519, 0.19341307, 0.35222604, 0.23225088, 0.58998089, 0.75704803, 1.0594766, 0.99483187,
             0.99746057]),
        "spline_degree": 3
    },
    "Rubber": {
        "mean_params": [0.0762, 1.7733, 4.9242, 13.7612, 11.1784, -0.0134, 11.6065],
        "std_params": [0.0442, 0.7506, -0.0327, 16.8177, 28.5469, -0.0092, 12.8841],
        "spline_knots": np.array(
            [1.0, 6.6, 8.0, 8.7, 8.9, 9.1, 9.4, 10.8, 11.5, 12.1, 12.8, 13.5, 14.9, 17.7, 23.2, 34.3, 39.9, 45.4, 56.5,
             67.6, 73.2, 78.7, 81.5, 84.2, 89.7]),
        "spline_coefs": np.array(
            [-0.00442207, 0.0236799, -0.06173036, 0.10060097, 0.08998055, 0.16647941, 0.21744572, 0.29387713,
             0.14172869, 0.3620609, 0.21992156, 0.29234354, 0.303058, 0.36136923, 0.21753638, 0.1887377, 0.25417031,
             0.19102416, 0.28284315, 0.50597398, 0.5534661, 0.56718998, 0.66767955, 0.97332787, 1.03670856, 0.9730833,
             1.00926311]),
        "spline_degree": 3
    },
    "Paint": {
        "mean_params": [0.6318, 1.1418, -0.6532, 26.2342, 16.8385, -0.3907, 4.6776],
        "std_params": [0.0646, 0.4814, -0.0602, 13.1040, 22.6623, 0.2092, 2.4302],
        "spline_knots": np.array([1.0, 6.6, 8.0, 9.4, 12.1, 17.7, 23.2, 45.4, 67.6, 73.2, 78.7, 89.7]),
        "spline_coefs": np.array(
            [-0.00934347, -0.05865647, 0.03544178, 0.17072359, 0.25306772, 0.35976321, 0.34930158, 0.10761186,
             0.16798335, 0.47131203, 0.60018445, 0.83796636, 1.0802168, 0.98531586]),
        "spline_degree": 3
    }
}

material_ind = ["Aluminium", "SUS", "Rubber", "Paint"]
